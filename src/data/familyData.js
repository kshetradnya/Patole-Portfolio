export const familyMembers = [
  ...
  },
  {
    ...
    name: "Anrunya",
    surname: "Patole",
    role: "Cyber Security & Data Science Specialist",
    title: "MS-GBA & BIT CMA • Virginia Tech | BTech CSDS • NMIMS",
    image: "anrunya_original.png",
    accent: "#8b5cf6",
    accentDark: "#6d28d9",
    bio: "Currently pursuing an MS-GBA and specializing in BIT CMA (Cybersecurity Management and Analytics) at Virginia Tech, building upon a strong foundation with a BTech in CSDS from NMIMS.",
    achievements: ["Pursuing MS-GBA at Virginia Tech", "BIT CMA from Virginia Tech", "BTech CSDS from NMIMS"],
    projects: [
